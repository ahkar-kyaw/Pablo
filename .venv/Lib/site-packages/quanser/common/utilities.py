...
runtime_lib = ffi.dlopen(add_common_path("quanser_runtime"))
...
def count_list_elements(l):
    """Returns the total number of elements in a list. Use to get total number of elements in list of list."""
